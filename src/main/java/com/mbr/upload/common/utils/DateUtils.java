...
//        Date oDate = new GregorianCalendar(2017, 6, 15,13,13,0).getTime();
//        System.out.println(DateUtils.formatDate(oDate));
//        System.out.println(DateUtils.daysOfTwo(oDate,new Date()));
//    }
}
